...
var createRoom = function (data, type) {
    var _a;
    return _a = {
            _id: "room$newRoom"
        },
        _a[type] = [data._id],
        _a.name = data.roomName,
        _a.image = data.roomImage,
        _a.color = data.roomColor,
        _a.owner = data.host,
        _a;
};
var joinToRoom = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, roomId, config;
