"use strict";
var publicEventStructure = function (data) {
    return data.filter(function (x) {
        ...
        return {
            ...
            parcipiantAnswers: z["publicEvents/parcipiantsAnswer"] === undefined ? undefined : z["publicEvents/parcipiantsAnswer"].map(function (par) {
                return {
            ...
            validatorsAnswers: z["publicEvents/validatorsAnswer"] === undefined ? undefined : z["publicEvents/validatorsAnswer"].map(function (val) {
                return {
...
var privateEventStructure = function (data) {
    return data.map(function (z) {
        return {
            ...
            parcipiantAnswers: z["privateEvents/parcipiantsAnswer"] === undefined ? undefined : z["privateEvents/parcipiantsAnswer"].map(function (par) {
                return {
...
var getPrivateColor = function (z) {
...
module.exports = {
    publicEventStructure: publicEventStructure,
    privateEventStructure: privateEventStructure
};
