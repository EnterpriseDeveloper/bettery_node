...
var setPaymentToDB_1 = __importDefault(require("./setPaymentToDB"));
...
var payToLosers = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var id, avarageBet, calcMintedToken, path, contract, gasEstimate, _a, _b, err_1;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                console.log(data);
                id = data.id;
                avarageBet = data.avarageBet;
                calcMintedToken = data.calcMintedToken;
            ...
            case 2:
                _d.trys.push([2, 8, , 9]);
                return [4 /*yield*/, contract.methods.letsPayToLoosers(id, avarageBet, calcMintedToken).estimateGas()];
            case 3:
                gasEstimate = _d.sent();
                _b = (_a = contract.methods.letsPayToLoosers(id, avarageBet, calcMintedToken)).send;
                _c = {
            ...
            case 6:
                _d.sent();
                return [4 /*yield*/, setPaymentToDB_1.default.setToDB(data)];
            case 7:
                _d.sent();
                return [3 /*break*/, 9];
            case 8:
                err_1 = _d.sent();
                console.log("err from pay to losers", err_1);
                return [3 /*break*/, 9];
