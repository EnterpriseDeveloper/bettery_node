...
var payToHost = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var id, premDF, mintDF, mintCMF, mintMF, path, contract, gasEstimate, _a, _b, err_1;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                _d.trys.push([2, 7, , 8]);
                return [4 /*yield*/, contract.methods.letsPaytoHost(id).estimateGas()];
            case 3:
                gasEstimate = _d.sent();
                _b = (_a = contract.methods.letsPaytoHost(id)).send;
                _c = {
            ...
            case 7:
                err_1 = _d.sent();
                console.log("err from pay to host", err_1);
                return [3 /*break*/, 8];
