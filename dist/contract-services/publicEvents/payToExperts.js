...
var payToExperts = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var id, mintHost, payHost, mintAdv, payAdv, path, contract, gasEstimate, _a, _b, err_1;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                console.log(data);
                id = data.id;
                mintHost = data.mintHost;
                payHost = data.payHost;
                mintAdv = data.mintAdv;
                payAdv = data.payAdv;
            ...
            case 2:
                _d.trys.push([2, 8, , 9]);
                return [4 /*yield*/, contract.methods.letsPayToExperts(id).estimateGas()];
            case 3:
                gasEstimate = _d.sent();
                _b = (_a = contract.methods.letsPayToExperts(id)).send;
                _c = {
            ...
            case 6:
                _d.sent();
                return [4 /*yield*/, setToDb(id, mintHost, payHost, mintAdv, payAdv)];
            case 7:
                _d.sent();
                return [3 /*break*/, 9];
            case 8:
                err_1 = _d.sent();
                console.log("err from pay to experts", err_1);
                return [3 /*break*/, 9];
            case 9: return [2 /*return*/];
        }
    });
}); };
var setToDb = function (id, mintHost, payHost, mintAdv, payAdv) { return __awaiter(void 0, void 0, void 0, function () {
    var web3, data;
