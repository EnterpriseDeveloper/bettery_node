...
var findCorrectAnswer = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var id, path, contract, gasEstimate, _a, _b, err_1;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                _d.trys.push([2, 7, , 8]);
                return [4 /*yield*/, contract.methods.letsFindCorrectAnswer(id).estimateGas()];
            case 3:
                gasEstimate = _d.sent();
                _b = (_a = contract.methods.letsFindCorrectAnswer(id)).send;
                _c = {
            ...
            case 7:
                err_1 = _d.sent();
                console.log("err from find correct answer", err_1);
                return [3 /*break*/, 8];
