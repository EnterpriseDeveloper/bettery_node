...
var getAdditionalData = function (events, res) { return __awaiter(void 0, void 0, void 0, function () {
    var i, confComment, comments;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, axios_1.default.post(path_1.default.path + "/query", confComment)
                        .catch(function (err) {
